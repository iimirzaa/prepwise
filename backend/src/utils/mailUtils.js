...
var mailOptions = {
  ...
  to: mail,
  subject: "One-Time verfication key- Prepwise",
  html: `
  <!DOCTYPE html>
  <html lang="en">
  <head>
  ...
  <body style="font-family: Arial, sans-serif; color: #333; margin: 0; padding: 20px;">
      <div style="max-width: 600px; margin: auto; padding: 20px; background-color: #f9f9f9; border-radius: 8px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
          ...
          <p style="margin-top: 20px; text-align: center; font-size: 14px; color: #888;">Best regards,<br>Team Prepwise</p>
...
await transporter.sendMail(mailOptions);
    ...
    Logger.debug("Otp sent succesfully");
    return otp;

}catch(e){
   Logger.error("Verification Email Error:", e);
}
}
